...
export default function NovoRclPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage({ type: 'error', text: error.message || 'Erro ao criar RCL' });
    } finally {
      setLoading(false);
    }
  };
    ...
    <DashboardLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Nova RCL</h1>
            <p className="text-gray-600 dark:text-gray-400">Cadastre a Receita Corrente Líquida para um ente</p>
          </div>
        </div>
